...
//        }
        ...
        try {
            ...
            angajati = mainRepository.getAngajati();

            rezervari = mainRepository.getRezervari();

            servicii = mainRepository.getServicii();
        ...
        return new ServiceAuto("UrgentService", "Strada Martisor nr 5, sector 4, Bucuresti",
                766532341, angajati, rezervari, servicii, manager);
    }
