...
public class ServiceAuto implements ServiceContract {
    ...
    public String getManager() { return manager.toString(); }

    public void addAngajat(Angajat angajat){this.angajati.add(angajat);}

    public void addRezervare(Rezervari rezervare){this.rezervari = Rezervari.addRezervare(rezervari, rezervare);}

    public void addServiciu(Servicii serviciu){this.servicii = Servicii.addServiciu(servicii, serviciu);}
    ...
    public void actualizeazaSalariu(){
        int indexAngajat = 0;
        for (Angajat angajat : angajati) {
            System.out.println(Integer.toString(indexAngajat) + '.' + angajat);
            indexAngajat++;
        }
        System.out.println("Introduceti index-ul angajatului caruia doriti sa ii actualizati salariul:");
        int index = scanner.nextInt();
        System.out.println("Introduceti salariul dorit:");
        ...
        this.angajati.get(index).setSalariu(salariu);
        System.out.println("***Angajatului cu index-ul " + index + " are acum salariul: " + salariu + "***");
